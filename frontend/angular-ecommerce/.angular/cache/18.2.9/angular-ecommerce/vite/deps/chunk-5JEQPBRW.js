  ...
  "node_modules/core-js-pure/modules/es.reflect.construct.js"() {
    ...
    $({
      ...
      construct: function construct(Target, args) {
        ...
        var instance = create5(isObject2(proto) ? proto : ObjectPrototype);
...
var require_create = __commonJS({
  "node_modules/core-js-pure/es/object/create.js"(exports, module) {
    ...
    module.exports = function create5(P, D) {
  ...
  "node_modules/core-js-pure/modules/es.symbol.constructor.js"() {
    ...
    var $getOwnPropertyNames = function getOwnPropertyNames(O) {
      ...
      $forEach(names, function(key) {
        if (!hasOwn(AllSymbols, key) && !hasOwn(hiddenKeys, key)) push2(result, key);
      });
      return result;
    };
  ...
  "node_modules/core-js-pure/internals/get-json-replacer-function.js"(exports, module) {
    ...
    module.exports = function(replacer) {
      ...
      for (var i = 0; i < rawLength; i++) {
        ...
        else if (typeof element == "number" || classof(element) === "Number" || classof(element) === "String") push2(keys, toString(element));
      }
...
var require_iterators_core = __commonJS({
  "node_modules/core-js-pure/internals/iterators-core.js"(exports, module) {
    ...
    else if (IS_PURE) IteratorPrototype = create5(IteratorPrototype);
...
var require_iterator_create_constructor = __commonJS({
  "node_modules/core-js-pure/internals/iterator-create-constructor.js"(exports, module) {
    ...
    module.exports = function(IteratorConstructor, NAME, next, ENUMERABLE_NEXT) {
      ...
      IteratorConstructor.prototype = create5(IteratorPrototype, {
        ...
        forEach(["add", "clear", "delete", "forEach", "get", "has", "set", "keys", "values", "entries"], function(KEY) {
          ...
          if (KEY in NativePrototype && !(IS_WEAK && KEY === "clear")) {
            createNonEnumerableProperty(Prototype, KEY, function(a3, b3) {
              ...
              if (!IS_ADDER && IS_WEAK && !isObject2(a3)) return KEY === "get" ? void 0 : false;
    ...
    $({
      ...
      filter: function filter(callbackfn) {
        ...
        iterate(map, function(value, key) {
          if (boundFunction(value, key, map)) set2(newMap, key, value);
        });
        return newMap;
      }
    });
  ...
  "node_modules/core-js-pure/modules/esnext.map.get-or-insert.js"() {
    ...
    $({
      ...
      getOrInsert: function getOrInsert(key, value) {
        if (has(aMap(this), key)) return get3(this, key);
        set2(this, key, value);
        return value;
      }
    });
  ...
  "node_modules/core-js-pure/modules/esnext.map.get-or-insert-computed.js"() {
    ...
    $({
      ...
      getOrInsertComputed: function getOrInsertComputed(key, callbackfn) {
        aMap(this);
        aCallable(callbackfn);
        if (has(this, key)) return get3(this, key);
  ...
  "node_modules/core-js-pure/modules/es.aggregate-error.constructor.js"() {
    ...
    var $AggregateError = function AggregateError(errors, message) {
      ...
      if (setPrototypeOf) {
        ...
        that = isInstance ? this : create5(AggregateErrorPrototype);
    ...
    var AggregateErrorPrototype = $AggregateError.prototype = create5($Error.prototype, {
...
var require_es_date_to_json = __commonJS({
  "node_modules/core-js-pure/modules/es.date.to-json.js"() {
    ...
    var FORCED = fails(function() {
      return (/* @__PURE__ */ new Date(NaN)).toJSON() !== null || call(Date.prototype.toJSON, {
...
var require_typeof = __commonJS({
  "node_modules/@babel/runtime-corejs3/helpers/typeof.js"(exports, module) {
    ...
    function _typeof3(o) {
      ...
      return module.exports = _typeof3 = "function" == typeof _Symbol5 && "symbol" == typeof _Symbol$iterator2 ? function(o2) {
        return typeof o2;
      } : function(o2) {
  ...
  "node_modules/@babel/runtime-corejs3/helpers/regeneratorRuntime.js"(exports, module) {
    ...
    function _regeneratorRuntime2() {
      ...
      return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", {
        ...
        var e2 = Object(t2), r2 = [];
        for (var n2 in e2) _pushInstanceProperty3(r2).call(r2, n2);
        ...
        reset: function reset(e2) {
          var _context3;
          if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = false, this.delegate = null, this.method = "next", this.arg = t, _forEachInstanceProperty(_context3 = this.tryEntries).call(_context3, resetTryEntry), !e2) for (var r2 in this) "t" === r2.charAt(0) && n.call(this, r2) && !isNaN(+_sliceInstanceProperty3(r2).call(r2, 1)) && (this[r2] = t);
        },
        stop: function stop() {
          this.done = true;
...
var require_es_reflect_get = __commonJS({
  "node_modules/core-js-pure/modules/es.reflect.get.js"() {
    ...
    function get3(target, propertyKey) {
      ...
      if (isObject2(prototype = getPrototypeOf(target))) return get3(prototype, propertyKey, receiver);
    }
    $({
      target: "Reflect",
      stat: true
...
var require_web_url_search_params_constructor = __commonJS({
  "node_modules/core-js-pure/modules/web.url-search-params.constructor.js"(exports, module) {
    ...
    var URLSearchParamsState = function(init2) {
      ...
      this.url = null;
      if (init2 !== void 0) {
        if (isObject2(init2)) this.parseObject(init2);
    ...
    URLSearchParamsState.prototype = {
      ...
      serialize: function() {
        ...
        while (index < entries.length) {
          entry = entries[index++];
          push2(result, serialize(entry.key) + "=" + serialize(entry.value));
        }
        return join(result, "&");
      },
      update: function() {
    ...
    defineBuiltIns(URLSearchParamsPrototype, {
      ...
      getAll: function getAll(name) {
        ...
        var index = 0;
        for (; index < entries.length; index++) {
          if (entries[index].key === key) push2(result, entries[index].value);
        }
        return result;
      },
  ...
  "node_modules/core-js-pure/internals/string-punycode-to-ascii.js"(exports, module) {
      ...
      while (counter < length) {
        ...
        if (value >= 55296 && value <= 56319 && counter < length) {
          ...
          if ((extra & 64512) === 56320) {
            push2(output, ((value & 1023) << 10) + (extra & 1023) + 65536);
          } else {
            push2(output, value);
            counter--;
          }
    ...
    var encode = function(input) {
      ...
      for (i = 0; i < input.length; i++) {
        ...
        if (currentValue < 128) {
          push2(output, fromCharCode(currentValue));
        }
      }
      var basicLength = output.length;
      var handledCPCount = basicLength;
      if (basicLength) {
        push2(output, delimiter);
      }
        ...
        for (i = 0; i < input.length; i++) {
          ...
          if (currentValue === n) {
            ...
            while (true) {
              ...
              push2(output, fromCharCode(digitToBasic(t + qMinusT % baseMinusT)));
              q = floor(qMinusT / baseMinusT);
              k += base;
            }
            push2(output, fromCharCode(digitToBasic(q)));
    ...
    module.exports = function(input) {
      ...
      for (i = 0; i < labels.length; i++) {
        label = labels[i];
        push2(encoded, exec(regexNonASCII, label) ? "xn--" + encode(label) : label);
      }
      return join(encoded, ".");
    };
  }
...
var require_web_url_constructor = __commonJS({
  "node_modules/core-js-pure/modules/web.url.constructor.js"() {
    ...
    var stringSlice = uncurryThis("".slice);
    var toLowerCase = uncurryThis("".toLowerCase);
    var unshift2 = uncurryThis([].unshift);
          ...
          switch (state) {
            ...
            case FILE_SLASH:
              ...
              if (base && base.scheme === "file" && !startsWithWindowsDriveLetter(join(arraySlice(codePoints, pointer), ""))) {
                if (isWindowsDriveLetter(base.path[0], true)) push2(url.path, base.path[0]);
...
function _setPrototypeOf(t, e) {
  var _context2;
  return _setPrototypeOf = import_set_prototype_of.default ? (0, import_bind.default)(_context2 = import_set_prototype_of.default).call(_context2) : function(t2, e2) {
...
function _inherits(t, e) {
  ...
  }), (0, import_define_property.default)(t, "prototype", {
    writable: false
...
function _getPrototypeOf(t) {
  var _context2;
  return _getPrototypeOf = import_set_prototype_of2.default ? (0, import_bind2.default)(_context2 = import_get_prototype_of.default).call(_context2) : function(t2) {
...
function _isNativeFunction(t) {
  try {
    var _context2;
    return -1 !== (0, import_index_of.default)(_context2 = Function.toString.call(t)).call(_context2, "[native code]");
  } catch (n) {
...
function _wrapNativeSuper(t) {
  var r = "function" == typeof import_map.default ? new import_map.default() : void 0;
  return _wrapNativeSuper = function _wrapNativeSuper3(t2) {
...
function asyncGeneratorStep(n, t, e, r, o, a3, c2) {
  try {
    var i = n[a3](c2), u = i.value;
  } catch (n2) {
    return void e(n2);
  }
...
function _defineProperties(e, r) {
  for (var t = 0; t < r.length; t++) {
    var o = r[t];
    o.enumerable = o.enumerable || false, o.configurable = true, "value" in o && (o.writable = true), (0, import_define_property2.default)(e, toPropertyKey(o.key), o);
  }
}
function _createClass(e, r, t) {
  return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), (0, import_define_property2.default)(e, "prototype", {
    writable: false
  }), e;
}
  ...
  if (null != t) {
    ...
    try {
      if (i = (t = t.call(r)).next, 0 === l) {
        ...
        f = false;
      } else for (; !(f = (e = i.call(t)).done) && ((0, import_push2.default)(a3).call(a3, e.value), a3.length !== l); f = true) ;
    } catch (r2) {
      o = true, n = r2;
    } finally {
      try {
...
function _unsupportedIterableToArray(r, a3) {
  if (r) {
    ...
    var t = (0, import_slice.default)(_context2 = {}.toString.call(r)).call(_context2, 8, -1);
    return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? (0, import_from.default)(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a3) : void 0;
  }
}
...
LeaderElection.prototype = {
  ...
  applyOnce: function applyOnce(isFromFallbackInterval) {
    ...
    var applyRun = function applyRun2() {
      ...
      return _sendMessage(_this2, "apply").then(function() {
...
JSONPath.prototype.vm = {
  ...
  runInNewContext: function runInNewContext(expr, context) {
    ...
    return _construct2(Function, _toConsumableArray2(keys).concat([code])).apply(void 0, _toConsumableArray2(values));
  }
};
...
function _defineProperty(e, r, t) {
  return (r = toPropertyKey(r)) in e ? (0, import_define_property3.default)(e, r, {
    value: t,
    enumerable: true,
    configurable: true,
    writable: true
...
function _get() {
  var _context2;
  return _get = "undefined" != typeof Reflect && import_get.default ? (0, import_bind4.default)(_context2 = import_get.default).call(_context2) : function(e, t, r) {
    var p = _superPropBase(e, t);
    if (p) {
      var n = (0, import_get_own_property_descriptor.default)(p, t);
...
function _handleOAuthResponse() {
  _handleOAuthResponse = _asyncToGenerator(import_regenerator.default.mark(function _callee(sdk, tokenParams, res, urls) {
    var pkce, responseType, scopes, clientId, tokenDict, expiresIn, tokenType, accessToken, idToken, refreshToken, now2, accessJwt, idJwt, idTokenObj, validationParams;
    return import_regenerator.default.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
...
var storageUtil = {
  ...
  getLocalStorage: function getLocalStorage2() {
    return localStorage;
  },
...
var SdkClock = function() {
  ...
  _createClass(SdkClock2, [{
    key: "now",
    value: function now2() {
      var now3 = (Date.now() + this.localOffset) / 1e3;
      return now3;
    }
  }], [{
    key: "create",
...
var TokenManager = function() {
  ...
  _createClass(TokenManager2, [{
    ...
    value: function getStorageKeyByType(type5) {
      var _context3;
      var tokenStorage = this.storage.getStorage();
    ...
    value: function setTokens(tokens, accessTokenCb, idTokenCb, refreshTokenCb) {
      ...
      var handleTokenCallback = function handleTokenCallback2(key, token) {
        var type5 = _this3.getTokenType(token);
      ...
      types.forEach(function(type5) {
        var token = tokens[type5];
        if (token) {
          validateToken(token, type5);
        }
      });
      var storage = (0, import_reduce.default)(types).call(types, function(storage2, type5) {
        var token = tokens[type5];
        if (token) {
          var storageKey2 = _this3.getStorageKeyByType(type5) || type5;
      ...
      types.forEach(function(type5) {
        var newToken = tokens[type5];
        var existingToken = existingTokens[type5];
        var storageKey2 = _this3.getStorageKeyByType(type5) || type5;
    ...
    value: function startElector() {
      ...
      if (ServiceManager2.canUseLeaderElection()) {
        if (!this.channel) {
          ...
          this.channel = new BroadcastChannel2(broadcastChannelName);
        }
        if (!this.elector) {
...
var PromiseQueue = function() {
  ...
  _createClass(PromiseQueue2, [{
    key: "push",
    value: function push2(method, thisObject) {
      var _this = this;
...
var StorageManager = function() {
  ...
  _createClass(StorageManager2, [{
    ...
    value: function getTransactionStorage(options) {
      ...
      var storageKey2 = options.storageKey || TRANSACTION_STORAGE_NAME;
    ...
    value: function getSharedTansactionStorage(options) {
      ...
      logServerSideMemoryStorageWarning(options);
      var storage = this.getStorage(options);
      var storageKey2 = options.storageKey || SHARED_TRANSACTION_STORAGE_NAME;
      return new SavedObject(storage, storageKey2);
    }
  }, {
    ...
    value: function getOriginalUriStorage(options) {
      ...
      logServerSideMemoryStorageWarning(options);
      var storage = this.getStorage(options);
      var storageKey2 = options.storageKey || ORIGINAL_URI_STORAGE_NAME;
      return new SavedObject(storage, storageKey2);
    }
  }, {
    ...
    value: function getTokenStorage(options) {
      ...
      logServerSideMemoryStorageWarning(options);
      var storage = this.getStorage(options);
      var storageKey2 = options.storageKey || TOKEN_STORAGE_NAME;
      return new SavedObject(storage, storageKey2);
    }
  }, {
    key: "getHttpCache",
    value: function getHttpCache2(options) {
      ...
      var storage = this.getStorage(options);
      var storageKey2 = options.storageKey || CACHE_STORAGE_NAME;
      return new SavedObject(storage, storageKey2);
    }
  }, {
    ...
    value: function getLegacyPKCEStorage(options) {
      ...
      var storage = this.getStorage(options);
      var storageKey2 = options.storageKey || PKCE_STORAGE_NAME;
      return new SavedObject(storage, storageKey2);
    }
  }, {
    ...
    value: function getLegacyOAuthParamsStorage(options) {
      ...
      var storage = this.getStorage(options);
      var storageKey2 = options.storageKey || REDIRECT_OAUTH_PARAMS_NAME;
      return new SavedObject(storage, storageKey2);
    }
  }]);
...
var _context;
var SKIP_FIELDS = (0, import_from_entries.default)((0, import_map2.default)(_context = ["remediation", "context"]).call(_context, function(field) {
  return [field, true];
}));
var parseNonRemediations = function parseNonRemediations2(authClient, idxResponse) {
  ...
  (0, import_filter.default)(_context2 = (0, import_keys.default)(idxResponse)).call(_context2, function(field) {
    ...
    var _a = idxResponse[field], fieldValue = _a.value, type5 = _a.type, info = __rest(_a, ["value", "type"]);
...
var Remediator = function() {
  ...
  _createClass(Remediator2, [{
    ...
    value: function getNextStep2(_context2) {
      ...
      var type5 = authenticator === null || authenticator === void 0 ? void 0 : authenticator.type;
    ...
    value: function getInputs() {
      ...
      inputsFromRemediation.forEach(function(inputFromRemediation) {
        var input;
        var name = inputFromRemediation.name, type5 = inputFromRemediation.type, visible = inputFromRemediation.visible, messages = inputFromRemediation.messages;
        if (visible === false) {
          return;
        }
...
var RedirectIdp = function(_Remediator) {
  ...
  _createClass(RedirectIdp2, [{
    ...
    value: function getNextStep2() {
      var _this$remediation = this.remediation, name = _this$remediation.name, type5 = _this$remediation.type, idp = _this$remediation.idp, href = _this$remediation.href;
      return {
        name,
        type: type5,
        idp,
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 8:
            ...
            _iterator = _createForOfIteratorHelper2(actions);
            _context4.prev = 14;
...
var EmailVerifyCallbackError = function(_CustomError) {
  ...
  var _super = _createSuper2(EmailVerifyCallbackError2);
...
@okta/okta-auth-js/esm/esm.browser.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-5JEQPBRW.js.map
